...
async def chat(req: ChatRequest, current_user=Depends(get_current_user)):
    ...
    async def event_generator():
        ...
        system_msg = (
            ...
            "GREETINGS: If the user says 'hi', 'hello', 'আসসালামু আলাইকুম', 'হাই', or any casual greeting, "
            "respond warmly and ask how you can help with their diet or nutrition today. NEVER reject a greeting.\n\n"
            "OFF-TOPIC HANDLING: Only if a question has ZERO connection to food, nutrition, diet, or health, "
            ...
            "The report must include average calories, macronutrient (protein, carb, fat) progress vs targets, specific micronutrient deficiencies, and weight trends. "
