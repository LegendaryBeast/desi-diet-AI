...
| `disease_nutrients.csv` | 70 records | Disease–nutrient clinical mappings sourced from the Indian Thali dataset (Dindukurthi et al., 2026). Verified by a consulting nutritionist (Sarmin Jahan Bithi). |
...
- **Disease-nutrient mappings**: Sourced from the Indian Thali GraphRAG dataset (Dindukurthi et al., 2026) and verified by a consulting nutritionist.

## License

The Bangladesh Food Composition Table (2014) is publicly available from the University of Dhaka. The disease–nutrient mappings are sourced from the Indian Thali dataset (Dindukurthi et al., 2026). Please cite the original sources when using these datasets.
