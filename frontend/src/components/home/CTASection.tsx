  ...
  return (
    <section className="px-6 md:px-12 lg:px-24 py-24 lg:py-40 text-center relative overflow-hidden bg-cream">
      ...
      <div className="relative z-10 flex flex-col items-center">
        <div className="text-[0.65rem] lg:text-[0.68rem] tracking-[0.2em] uppercase text-ink-faint mb-6 lg:mb-10">আপনার সুস্বাস্থ্য শুরু হোক আজ থেকে</div>
        
        <h2 className="font-display text-[clamp(2.5rem,8vw,6rem)] font-black leading-[0.95] tracking-tight mb-8">
          <span className="font-bn text-[clamp(1.8rem,5vw,4.5rem)] font-bold block text-accent mb-2">আপনার পুষ্টি</span>
          Your Health,<br /><em className="italic text-ink-muted">Your Rules</em>
        </h2>
        
        <p className="font-bn text-[0.95rem] lg:text-[1.1rem] leading-[1.8] text-ink-muted max-w-[450px] mb-12">
          বাংলাদেশের খাবার, বাংলাদেশের বিজ্ঞান — আপনার জীবনের জন্য।
        </p>
